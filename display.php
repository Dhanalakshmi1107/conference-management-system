...
<body class="main">
        ...
        <div class="container-fluid">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item" rel="import" href="details.html">DETAILS PAGE</a></li>
 ...
 <div class="heading">
    <h3 style="font-size:40px"><strong>SELECTED LIST</strong></h3>
</div>
 <table class="tb">
...
$sql = "SELECT name,title,status  FROM selection";
